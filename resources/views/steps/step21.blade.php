...
<div class="d-flex justify-content-between">
    ...
    <button type="button" class="btn_atras" onclick="cambiarSeccion('step_20', 'step20')" style="display: none;" id="btn_atras_1">Atrás</button>
    <button type="button" class="btn_atras" onclick="cambiarSeccion('step_17', 'step17')" id="btn_atras_2">Atrás</button>
